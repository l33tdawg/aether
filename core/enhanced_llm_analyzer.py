...
class EnhancedLLMAnalyzer:
    ...
    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None):
        ...
        self.fallback_models = ["claude-sonnet-4-5-20250929", "gemini-3-flash-preview", "gpt-4o-mini", "gpt-4.1-mini", "gpt-4-turbo", "gpt-3.5-turbo"]
        ...
        self.model_context_limits = {
            ...
            # Gemini 3 models
            "gemini-3-flash-preview": 2000000,  # 2M tokens combined
            "gemini-3-pro-preview": 2000000,    # 2M tokens combined
            "gemini-3.1-flash-lite-preview": 2000000,  # 2M tokens combined
