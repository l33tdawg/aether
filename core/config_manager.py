...
class AetherConfig:
    ...
    agent_gemini_security_model: str = "gemini-3-flash-preview"     # Gemini security hunter (2M context)
    agent_gemini_verification_model: str = "gemini-3-pro-preview"   # Formal verification (use Pro for best quality)
...
def get_model_for_task(task_type: str) -> str:
    ...
    Returns:
        The model name to use (e.g., 'gpt-5-chat-latest' or 'gemini-3-flash-preview')
    """
    try:
